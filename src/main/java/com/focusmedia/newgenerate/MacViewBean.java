...
public class MacViewBean implements Serializable {
    ...
    public MacViewBean(String devid, String iccid, String inner_sn, String mac, String sch_version, String uploadcount,
                       String pls_index, String play_index, String plninfo, String start_time, long start_time_long,
                       String end_time, long end_time_long,long time_diff) {
        this.devid = devid;
        this.iccid = iccid;
