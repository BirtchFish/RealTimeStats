...
public class MacResultBeanAD implements Serializable {
    ...
    public MacResultBeanAD(){}

    public MacResultBeanAD(String devid, String iccid, String inner_sn, String mac, String sch_version, String uploadcount,
